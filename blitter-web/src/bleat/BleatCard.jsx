    ...
    return (
      <form className="mb-6" onSubmit={postComment}>
        <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          <label htmlFor="replyContents" className="sr-only">Your comment</label>
          <textarea 
            id="replyContents" 
            rows="6"
            name='replyContents'
    ...
    return (
      <div className='mt-3 flex text-gray-500 dark:text-gray-400'>
        <button className='mr-6 flex items-center ' onClick={toggleLike}>
          <HeartIcon
            className={`h-5 w-5 hover:fill-red-700 hover:stroke-red-700 ${authorLiked ? 'fill-red-700 stroke-red-700' : ''
} `}
            />
          ...
          <div className='flex items-center'>
            ...
            <div className='ml-1.5 text-sm leading-tight'>
              <span className='block font-bold text-black dark:text-white '>
                ...
                <Link
                    to={`/users/${bleat.author_username}`}
                >
